...
mod tests {
    ...
    async fn test_version_consistency_and_packaging_metadata() {
        ...
        assert!(
            root_cargo.contains("version = \"1.0.0\""),
            "Root Cargo.toml must declare version 1.0.0"
        );
        ...
        assert!(
            root_pkg.contains("\"version\": \"1.0.0\""),
            "Root package.json must declare version 1.0.0"
        );
        ...
        assert!(
            desktop_pkg.contains("\"version\": \"1.0.0\""),
            "apps/desktop/package.json must declare version 1.0.0"
        );
        ...
        assert!(
            types_pkg.contains("\"version\": \"1.0.0\""),
            "packages/types/package.json must declare version 1.0.0"
        );
        ...
        assert!(
            tauri_conf.contains("\"version\": \"1.0.0\""),
            "tauri.conf.json must declare version 1.0.0"
        );
        assert!(
