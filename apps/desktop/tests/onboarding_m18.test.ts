...
describe("BBQ — Milestone 18: Production Packaging, Onboarding & First-Run Experience", () => {
  ...
  describe("3. Settings Widget About & Identity", () => {
    ...
    it("displays version 1.0.0 and MIT License in About section", () => {
      assert.ok(
        settingsCode.includes("Version 1.0.0 (Production Edition)"),
        "SettingsWidget missing version 1.0.0 badge"
      );
      assert.ok(
